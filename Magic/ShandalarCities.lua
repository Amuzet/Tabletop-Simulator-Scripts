...
Seeder={'Nothing of Note','Starting City','An Additional Haggle','One less Haggle','Shop Price Double','Shop Price Half','Conjurer`s Will','Leap of Fate','Quickening','Thunderstaff','Sword of Restance','Slight of Hand','Tome of Knowledge','Haggler`s Coin','Fruit of Sustance','Dwarven`s Pick','Ring of the Guardian','Dungeon Red','Dungeon Green','Dungeon White','Dungeon Blue','Dungeon Black'}
Copy,Gen={},'Shandalar'
Terra={'Plains','Plains','Water','Swamp','Mountain','Forest'}
Color.Add('Plains',Color.new(179/255,158/255,54/255))
Color.Add('Water',Color.new(33/255,177/255,155/255))
Color.Add('Swamp',Color.new(64/255,32/255,64/255))
Color.Add('Mountain',Color.new(179/255,56/255,54/255))
Color.Add('Forest',Color.new(34/255,102/255,30/255))
...
function getExclusive(tbl,del)
  ...
  return result end
local Names={'The','Zephir','Windlass','Nevermoon','Celestine','Andor','Bloodsand','Pyreanian','Amanixis','Hornwall','Kraag','Shalecliff','Mandrake','Coldsnap','Eloren','Gavony','Thraben','Moorland','Trostad','Nearheath','Videns','Wittal','Effalen','Estwald','Hanweir','Kessig','Ulvenwald','Lambholt','Hollowhenge','Stensia','Somberwald','Ashmouth','Nephalia','Drunau','Havengul','Selhoff'}
...
function generatePositions()
  ...
  for i=#Cities[Gen],1,-1 do
    ...
    local new=self.clone({scale={0.4,0.4,0.4},position=getExclusive(location)})
    new.setLuaScript('')
