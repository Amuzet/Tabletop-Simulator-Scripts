...
[b]FOREFIT:[/b] When you 1d{do something impossible;flee from any monster;flee from a target;bribe a target;forefit this quest;leave a town without purchasing anything;purchace anything;leave this region;change terrain type}, then 1d{just dismiss this quest;don't sweat it;there is no penalty;your honor is bruised, but nothing else;lose 3d2-1 amulets;lose 2d2-1 amulets;lose 1{numPlayers}d9+9 gp;lose {numPlayers}1d9-9 gp;next duel you ante an additional card;next duel you mill a card;next duel discard a card;next duel you lose 3d2-2 life;lose a Mana Link}.
]],[[
[b]FERRY:[/b] Upto 4d2-1 1d{Red;Blue;Green;White;Black;Colorless;Multicolored} 1d{and;non;non;or;or;and/or;and/or} 1d{Creature;Enchantment;Sorcery;Instant;Common;Uncommon;Rare} cards.

[b]DESTINATION:[/b]
1d{A town under siege;A town 6d2+0 days away;A town 6d2+1 days away;The closest town;The next closest town;TOWN;TOWN}.
]]}
...
self.createButton({label='[b]Quest Generator[/b]\n\n[i]When entering a town\ngenerate 2 quests which\nthe party may accept any.\nHaving at most 3 quests at\nonce, forefiting any for\n99g at anytime.',font_color={1,1,1},position={0,0.01,0},font_size=250,scale={0.4,1,0.4},rotation={0,-90,0},width=0,height=0,click_function='Z',function_owner=self})end
